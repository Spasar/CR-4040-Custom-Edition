...
#define STRING_CONFIG_H_AUTHOR "Spasar" // Who made the changes.
 ...
 */
#define TEMP_SENSOR_0 998 //TODO: исправить на реальный термистор хотенда принтера
...
#define PID_MAX  100      // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93} //TODO: Замерить всё что нужно
...
#define CLASSIC_JERK
  ...
  #define TRAVEL_EXTRA_XYJERK 0     // Additional jerk allowance for all travel moves
